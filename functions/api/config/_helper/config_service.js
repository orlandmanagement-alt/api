import {getSettingsByPrefix,upsertSetting} from "./config_queries.js"
import {normalizeBool,normalizeInt,normalizeString} from "./config_validator.js"
...
export async function getConfigHealth(env){
  ...
  const missing = required.filter(k => !Object.prototype.hasOwnProperty.call(current, k) || String(current[k] || "").trim() === "")
  return {
    ok: missing.length === 0,
