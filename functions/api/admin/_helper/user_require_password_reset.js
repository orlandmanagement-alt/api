...
export async function onRequestPost({ request, env }){
  ...
  try{
    ...
    await auditEvent(env, request, {
      ...
      action: enabled ? "admin_require_password_reset" : "admin_clear_password_reset_requirement",
      target_type: "user",
      target_id: userId,
      http_status: 200,
      meta: { affected: Number(r?.meta?.changes || 0), enabled }
    });
    ...
    return json(500, "server_error", {
      message: "failed_to_update_password_reset_requirement",
